 ...
 */
@RestController
@RequestMapping("/entertainmentChart")
public class EntertainmentChartController extends BaseController
{
    @Autowired
     ...
     * 查询娱乐汇总列表
     */
    @RequiresPermissions("entertainment:entertainmentChart:list")
    @GetMapping("/list")
     ...
     * 导出娱乐汇总列表
     */
    @RequiresPermissions("entertainment:entertainmentChart:export")
    @Log(title = "娱乐汇总", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    public void export(HttpServletResponse response, Entertainment entertainment)
    {
        ...
        util.exportExcel(response, list, "娱乐汇总数据");
    }

    /**
     * 获取娱乐汇总详细信息
     */
    @RequiresPermissions("entertainment:entertainmentChart:query")
    @GetMapping(value = "/{id}")
     ...
     * 新增娱乐汇总
     */
    @RequiresPermissions("entertainment:entertainmentChart:add")
    @Log(title = "娱乐汇总", businessType = BusinessType.INSERT)
    @PostMapping
     ...
     * 修改娱乐汇总
     */
    @RequiresPermissions("entertainment:entertainmentChart:edit")
    @Log(title = "娱乐汇总", businessType = BusinessType.UPDATE)
    @PutMapping
     ...
     * 删除娱乐汇总
     */
    @RequiresPermissions("entertainment:entertainmentChart:remove")
    @Log(title = "娱乐汇总", businessType = BusinessType.DELETE)
    @DeleteMapping("/{ids}")
