...
public class DiningController extends BaseController
{
     ...
     * 查询餐饮信息列表
     */
    @RequiresPermissions("entertainment:dining:list")
    @GetMapping("/list")
     ...
     * 导出餐饮信息列表
     */
    @RequiresPermissions("entertainment:dining:export")
     ...
     * 获取餐饮信息详细信息
     */
    @RequiresPermissions("entertainment:dining:query")
    @GetMapping(value = "/{id}")
     ...
     * 新增餐饮信息
     */
    @RequiresPermissions("entertainment:dining:add")
     ...
     * 修改餐饮信息
     */
    @RequiresPermissions("entertainment:dining:edit")
     ...
     * 删除餐饮信息
     */
    @RequiresPermissions("entertainment:dining:remove")
